...
export default function Step5WebsiteBuilder({
  ...
  const [selectedOption, setSelectedOption] = useState<"template" | "wordpress" | "custom" | null>(null);
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        >
          <div className="text-center mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Default Templates</h3>
            <p className="text-gray-600 text-sm">Choose from our professionally designed templates</p>
        ...
        {/* Option B: WordPress */}
        <div
          className="bg-white rounded-2xl p-6 border-2 border-gray-200 opacity-60 cursor-not-allowed relative"
        >
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-gray-600 text-sm">Full WordPress website with premium themes</p>
        ...
        >
          ...
          <div className="text-center mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Custom Code</h3>
            <p className="text-gray-600 text-sm">Fully custom website built to your specs</p>
            <div className="mt-3 inline-flex items-center gap-2 bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-xs font-bold">
              <FiLock className="w-4 h-4" />
              Coming Soon
            </div>
        ...
        <div className="bg-white rounded-2xl p-8 border-2 border-blue-200 mb-8">
              ...
              >
                ...
                <div className="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                  ...
                  <div className="text-center p-4">
                    ...
                    <p className="text-sm text-gray-500">{template.style} style</p>
                  </div>
                </div>
          ...
          <div className="mt-6 bg-blue-50 rounded-lg p-4 border border-blue-200">
            <p className="text-sm text-gray-700">
              <span className="font-bold text-blue-700">✨ Don't worry!</span> You can customize 
              colors, text, and images after selecting a template.
            </p>
          </div>
        </div>
      )}
      ...
      {selectedOption === "wordpress" && (
        <div className="bg-purple-50 rounded-2xl p-8 border-2 border-purple-200 mb-8 text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-2">WordPress Sites - Coming Soon! 🚀</h3>
          <p className="text-gray-600 mb-4">
            We're working on integrating premium WordPress themes. This will be a paid feature.
          </p>
