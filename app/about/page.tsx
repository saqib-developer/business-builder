    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">About Business Builder</h1>
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Empowering entrepreneurs to transform their ideas into thriving digital businesses
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-6">
              Business Builder is a comprehensive Final Year Project developed under the 
              organization <span className="font-bold text-blue-600">Doxfen</span>. Our mission 
              is to democratize entrepreneurship by providing a complete, user-friendly platform 
              that guides non-technical users from having a simple business idea to establishing 
              a full digital presence.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              We believe that everyone deserves the opportunity to bring their business dreams 
              to life, regardless of their technical expertise. Business Builder removes the 
              barriers and complexity, making the journey from idea to launch simple, exciting, 
              and achievable.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-200 mb-12">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Guiding our team with expertise and mentorship throughout this journey
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Passionate students building solutions for tomorrow's entrepreneurs
            </p>
          </div>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-gray-600 mb-4 min-h-[40px]">{member.role}</p>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Proud Member Of</h2>
          <p className="text-5xl md:text-6xl font-bold mb-6">Doxfen</p>
          <p className="text-xl text-blue-100 max-w-2xl mx-auto">
            Innovating and creating solutions that make a difference in the digital world
          </p>
        </div>
      </section>
    </div>
